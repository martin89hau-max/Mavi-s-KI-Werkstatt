  ...
  return (
    <section className="py-12 md:py-16 px-4 md:px-8">
      <div className="max-w-5xl mx-auto">
        <div className="flex flex-col sm:flex-row items-center gap-6 bg-gradient-to-r from-zinc-300/60 to-zinc-200/40 border border-zinc-300/60 rounded-2xl px-6 md:px-8 py-8 md:py-10">
          <div className="flex-shrink-0 bg-zinc-100 rounded-full p-4 md:p-5 border border-zinc-300/60">
